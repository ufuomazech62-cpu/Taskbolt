...
# Template for `taskbolt channels install <key>` stub (channel key substituted).
...
from taskbolt.app.channels.base import BaseChannel
from taskbolt.app.channels.schema import ChannelType
...
def configure_voice(
    ...
    welcome_greeting = click.prompt(
        ...
        or "Hi! This is Taskbolt. How can I help you?",
        type=str,
    )
