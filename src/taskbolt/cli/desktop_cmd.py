# -*- coding: utf-8 -*-
"""CLI command: run Taskbolt app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run Taskbolt app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing Taskbolt app instance.
    """
    ...
    click.echo(f"Starting Taskbolt app on {url} (port {port})")
