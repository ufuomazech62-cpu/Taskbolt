...
def chats_group() -> None:
    ...
    \b
    Common examples:
      taskbolt chats list                    # List all chats
      taskbolt chats list --user-id alice    # Filter by user
      taskbolt chats get <chat_id>           # View details
      taskbolt chats create --session-id s1 --user-id u1
      taskbolt chats delete <chat_id>        # Delete a chat
    """
...
def list_chats(
    ...
    Examples:
      taskbolt chats list
      taskbolt chats list --user-id alice
      taskbolt chats list --channel discord
      taskbolt chats list --user-id alice --channel discord
    """
...
def get_chat(
    ...
    \b
    CHAT_ID  Chat UUID, obtainable via `taskbolt chats list`.

    \b
    Examples:
      taskbolt chats get 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = _base_url(ctx, base_url)
    with client(base_url) as c:
        headers = {"X-Agent-Id": agent_id}
...
def create_chat(
    ...
    Inline creation examples:
      taskbolt chats create --session-id "discord:alice" \\
    ...
    JSON file creation example:
      taskbolt chats create -f chat.json
    """
    base_url = _base_url(ctx, base_url)
...
def update_chat(
    ...
    \b
    Examples:
      taskbolt chats update <chat_id> --name "Renamed Chat"
    """
    base_url = _base_url(ctx, base_url)
    headers = {"X-Agent-Id": agent_id}
...
def delete_chat(
    ...
    \b
    Examples:
      taskbolt chats delete 823845fe-dd13-43c2-ab8b-d05870602fd8
    """
    base_url = _base_url(ctx, base_url)
    with client(base_url) as c:
        headers = {"X-Agent-Id": agent_id}
