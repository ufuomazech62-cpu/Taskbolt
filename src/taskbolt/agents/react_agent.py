# -*- coding: utf-8 -*-
"""Taskbolt Agent - Main agent implementation.

This module provides the main TaskboltAgent class built on ReActAgent,
...
class TaskboltAgent(ToolGuardMixin, ReActAgent):
    """Taskbolt Agent with integrated tools, skills, and memory management.
    ...
    Python's MRO: TaskboltAgent → ToolGuardMixin → ReActAgent.  If you
    ...
    **must** call ``super()._acting(...)`` / ``super()._reasoning(...)``
    ...
    def _rebuild_mcp_client(client: Any) -> Any | None:
        ...
        rebuild_info = getattr(client, "_taskbolt_rebuild_info", None)
        ...
        try:
            if transport == "stdio":
                ...
                setattr(rebuilt_client, "_taskbolt_rebuild_info", rebuild_info)
                return rebuilt_client
