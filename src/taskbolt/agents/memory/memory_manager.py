...
"""Memory Manager for Taskbolt agents.
...
from taskbolt.agents.model_factory import create_model_and_formatter
from taskbolt.agents.tools import read_file, write_file, edit_file
from taskbolt.agents.utils import get_taskbolt_token_counter
from taskbolt.config.config import load_agent_config
...
class MemoryManager(ReMeLight):
    """Memory manager that extends ReMeLight for Taskbolt agents.
    ...
    async def compact_memory(
        ...
        **_kwargs,
        ...
        token_counter = get_taskbolt_token_counter(agent_config)
